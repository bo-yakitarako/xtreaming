import { Box, AppBar as MuiAppBar, Switch, Toolbar } from '@mui/material';
import { styled } from '@mui/material/styles';
import { deepOrange } from '@mui/material/colors';
import { useDark, useSetDark } from '../DarkModeContext';
...
const DartThemeSwitch = styled(Switch)(({ theme }) => {
  ...
  return {
    ...
    '& .MuiSwitch-thumb': {
      backgroundColor: mode === 'dark' ? '#003892' : '#fff',
      width: 32,
      height: 32,
      '&::before': {
        content: "''",
